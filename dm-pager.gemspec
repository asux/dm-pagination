...
Gem::Specification.new do |s|
  ...
  s.date = "2012-07-09"
  s.description = "DataMapper Pagination"
  ...
  s.homepage = "http://github.com/visionmedia/dm-pagination"
  s.rdoc_options = ["--line-numbers", "--inline-source", "--title", "Dm-pager", "--main", "Readme.md"]
  s.require_paths = ["lib"]
  s.rubyforge_project = "dm-pager"
  s.rubygems_version = "1.8.24"
  s.summary = "DataMapper Pagination"
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<dm-aggregates>, ["~> 1.1"])
      s.add_development_dependency(%q<dm-migrations>, ["~> 1.1"])
      s.add_development_dependency(%q<dm-sqlite-adapter>, ["~> 1.1"])
    else
      s.add_dependency(%q<dm-core>, ["~> 1.1"])
      s.add_dependency(%q<dm-aggregates>, ["~> 1.1"])
      s.add_dependency(%q<dm-migrations>, ["~> 1.1"])
      s.add_dependency(%q<dm-sqlite-adapter>, ["~> 1.1"])
    end
  else
    s.add_dependency(%q<dm-core>, ["~> 1.1"])
    s.add_dependency(%q<dm-aggregates>, ["~> 1.1"])
